...
<body>
        <!-- START HERE -->
    <!-- Start navbar -->
    <nav class="navbar navbar-expand-sm bg-primary navbar-light py-4"
         id="main-nav">
        <div class="container">
        ...
        <div class="container pb-5 pt-2">
            <div class="row">
                <div class="col text-center">
                    <h3 class="display-2 text-white mb-4">Contact Me</h3>
                    <p class="text-white">If you have questions or would like to talk business, please reach out via this contact form. Response time is usually between 1-3 business days.</p>
                    <div class="card card-body bg-info py-4 mt-4">
                        <form id="contactForm" runat="server" class="my-2">
                            ...
                            <div>
                                <asp:RequiredFieldValidator ID="subjectValidator" 
                                    runat="server" 
                            ...
                            <div id="fgSubject" runat="server" class="form-group">
                                <div class="input-group input-group-lg">
                                    ...
                                    <asp:TextBox ID="subject"
                                           class="form-control bg-light"
                                           placeholder="Subject" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div>
                                <asp:RequiredFieldValidator ID="messageValidator" 
                                    runat="server" 
                            ...
                            <div id="fgMessage" runat="server" class="form-group">
                                <div class="input-group input-group-lg">
                                    ...
                                    <asp:TextBox ID="message" 
                                        runat="server" 
                                        class="form-control bg-light"
                                        placeholder="Message" Rows="5" TextMode="MultiLine">
                                    </asp:TextBox>
                                </div>
                            </div>
                            <asp:Button ID="submitButton"
                                runat="server"
                                text="Submit"
                                class="btn btn-danger btn-block btn-lg text-white" OnClick="submitButton_Click" />
                        </form>
                        <h3 id="contactLabel" runat="server" Visible="False" class="display-4 text-white mb-3"></h3>
                    </div>
                </div>
            </div>
        </div>
